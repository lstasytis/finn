...
FILE="$TARGET_DIR/onnx-models-resnet50.zip"
URL=https://github.com/Xilinx/finn-examples/releases/download/v0.0.7a/onnx-models-resnet50.zip
EXTRACTED_FILE="$TARGET_DIR/resnet50_w1a2_exported.onnx"  # Change this if another file should be checked
