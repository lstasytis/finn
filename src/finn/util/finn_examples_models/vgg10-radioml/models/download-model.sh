...
FILE="$TARGET_DIR/onnx-models-vgg10-radioml.zip"
URL=https://github.com/Xilinx/finn-examples/releases/download/v0.0.7a/onnx-models-radioml.zip
EXTRACTED_FILE="$TARGET_DIR/vgg10-radioml.onnx"  # Change this if another file should be checked
