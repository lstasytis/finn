...
FILE="$TARGET_DIR/onnx-models-bnn-pynq.zip"
URL=https://github.com/Xilinx/finn-examples/releases/download/v0.0.1a/onnx-models-bnn-pynq.zip
EXTRACTED_FILE="$TARGET_DIR/cnv-w1a1.onnx"  # Change this if another file should be checked
